...
//  var legend_color_ranges=colors; 
 ...
 legend_color_ranges_3.forEach(colors => {
  ...
  i=0;
 legend_color_ranges_4.forEach(colors => {
    color_ranges_4.push({from:ranges_4[i][0],to:ranges_4[i][1],name:ranges_text_4[i],color:colors})
    i++;
 }); 


 var color_ranges=[color_ranges_1,color_ranges_2,color_ranges_3,color_ranges_4];
 var legend_color_ranges=[legend_color_ranges_1,legend_color_ranges_2,legend_color_ranges_3,legend_color_ranges_4];
...
// alert("heatmap_series: "+heatmap_series[0].length );
