...
<center>
  ...
  <div id="heatmap_graph" class="hide collapse">
    <div id="chart1_frame" style="border:2px solid #666; padding-top:7px">
      ...
      <div id="chart4" style="min-height: 400px;border-bottom:2px solid #666"></div>
    </div>
  </div>
</center>
</html>
...
<script type="text/javascript">
  ...
  sample_array[3] = <?php echo json_encode($data4["header"]) ?>;
  heatmap_series[3] = <?php echo json_encode(array_reverse($data4["heatmap"])); ?>;
</script>
