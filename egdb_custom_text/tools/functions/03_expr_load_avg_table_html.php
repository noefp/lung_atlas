...
<div id="avg_table" class="collapse hide">
  ...
  echo "<div id=\"tables_div\" style=\"display:none\">";
    echo "<b><i><h3 style=\"text-align:center;margin-top:20px;\">"."Single Cell Ctrl-ARDS"."</h3></i></b>";
    ...
    echo "<b><i><h3 style=\"text-align:center; margin-top:20px;\">"."Bulk RNA-seq ARDS"."</h3></i></b>";
    if ($data2["table"] != null) echo implode($data2["table"])."<hr>";
    else echo "<p class=\"alert alert-secondary\" style=\"text-align:center;\">"."Not results"."</p>"."<hr>";
    echo "<b><i><h3 style=\"text-align:center; margin-top:20px;\">"."Bulk RNA-seq SARSCOV2"."</h3></i></b>";
...
$(document).ready(function() {
  var table_id = ["#table1","#table2","#table3","#table4"];
